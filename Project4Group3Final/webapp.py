...
from collab_function import recommendation # This is the backend API 
...
app.layout = html.Div([
    ...
    html.Div(
    [
        # Add a button to call ml_model_function
...
# Created a callback function for the button
@app.callback(
...
def ml_model_callback(n_clicks, fever, cough, fatigue, breathing, gender, bp, cl, age):
    ...
    # transform the user input to 0s and 1s so model understands the input
...
# Remove the @callback decorator from ml_model_function
